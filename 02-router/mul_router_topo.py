...
if __name__ == '__main__':
    ...
    h2.cmd('ifconfig h2-eth0 10.0.4.33/24')
    ...
    r1.cmd('ip route add default via 10.0.2.2 dev r1-eth1')
    r1.cmd('ip route add 10.0.1.0/24 dev r1-eth0')

    r2.cmd('ifconfig r2-eth0 10.0.2.2/24')
    r2.cmd('ifconfig r2-eth1 10.0.4.1/24')
    r2.cmd('ip route add default via 10.0.2.1 dev r2-eth0')
    r2.cmd('ip route add 10.0.4.0/24 dev r2-eth1')
    for n in (h1, h2, r1, r2):
