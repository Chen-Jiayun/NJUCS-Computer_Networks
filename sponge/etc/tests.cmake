...
add_custom_target (check_lab1_1 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_webget|t_byte_stream|_dt'
                              COMMENT "Testing Lab 1-part 1...")     
add_custom_target (check_lab1_2 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 10 -R 't_strm_reassem_|t_byte_stream|_dt'
                              COMMENT "Testing Lab 1-part 2: the stream reassembler...")                              
...
add_custom_target (check_lab4 COMMAND "${PROJECT_SOURCE_DIR}/tun.sh" check 144 145
                              COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 30 -R "^t_"
...
add_custom_target (check COMMAND "${PROJECT_SOURCE_DIR}/tun.sh" check 144 145
                         ...
                         COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --timeout 30 -R '^t_|^arp_|^router_'
